...
//            }],
		...
		function drawEllipse(x, y, r, w, h, a, fillcolor,pathClass) {
			if(pathClass){
				__context.beginPath(pathClass);
			}else{
				__context.beginPath();
			}
			__context.save();
		...
		function drawTriangle(x1, y1, x2, y2, x3, y3, fillcolor,pathClass) {
			if(pathClass){
				__context.beginPath(pathClass);
			}else{
				__context.beginPath();
		...
		function drawCircle(x, y, r, w, h, a, strokecolor,pathClass) {
			if(pathClass){
				__context.beginPath(pathClass);
			}else{
				__context.beginPath();
		...
		function drawDoubleCircle(strokecolor,pathClass) {
			var counterClockwise = false;
			var beginPaths=function(){
				if(pathClass){
					__context.beginPath(pathClass);
				}else{
					__context.beginPath();
		...
		function drawCross(strokecolor,pathClass) {
			var counterClockwise = false;
			var beginPaths=function(){
				if(pathClass){
					__context.beginPath(pathClass);
		...
		function drawCross2(strokecolor,pathClass) {
			var counterClockwise = false;
			var beginPaths=function(){
				if(pathClass){
					__context.beginPath(pathClass);
		...
		function drawRoundRect(x, y, width, height, strokecolor,pathClass) {
		    var radius = 10;
			if(pathClass){
				__context.beginPath(pathClass);
			}else{
		...
		function drawAxis(ctx, startx, starty, endx, endy,nameId) {
			ctx.beginPath();
		...
		function drawRectangle(ctx, x, y, w, h, fillcolor, strokecolor,pathClass) {
			if(pathClass){
				ctx.beginPath(pathClass);
			}else{
				ctx.beginPath();
			}
			ctx.rect(x, y, w, h);
			...
			*/
			...
			for (var i=0; i<vennSize; i++) {
				drawRectangle(__context,
							  ...
							  barwidth,
							  dataplot[i],
							  changeOpacity(opts.colors[i], 0.6),
							  opts.colors[i],"square"+(i+1));
				...
				__context.fillStyle = "#000";
				__context.textAlign = 'center';
				__context.fillText($("#label"+(i+1)).html(), (xmargin + i*barwidth + i*xspacer) + barwidth/2, ytext, 200,"nameId"+(i+1));
		...
		function placeClassicVenn(vennSize) {
			...
			if (vennSize == 6) {
				drawTriangle(0,11,    254,160, 174,235, changeOpacity(opts.colors[0], $("#label1").css('opacity')),"path1");
				drawTriangle(188,0,   134,242, 236,202, changeOpacity(opts.colors[1], $("#label2").css('opacity')),"path2");
				drawTriangle(338,52,  135,123, 191,242, changeOpacity(opts.colors[2], $("#label3").css('opacity')),"path3");
				drawTriangle(500,260, 163,117, 134,219, changeOpacity(opts.colors[3], $("#label4").css('opacity')),"path4");
				drawTriangle(250,415, 133,150, 203,67,  changeOpacity(opts.colors[4], $("#label5").css('opacity')),"path5");
				drawTriangle(11,307,  263,81,  214,220, changeOpacity(opts.colors[5], $("#label6").css('opacity')),"path6");
				
				$("#label1").css("left",  35).css("top",  10)
				$("#label2").css("left", 200).css("top",   5)
				$("#label3").css("left", 335).css("top",  60)
				$("#label4").css("left", 410).css("top", 200)
				$("#label5").css("left", 255).css("top", 385)
				$("#label6").css("left",  30).css("top", 300)
				...
				drawEllipse(214,230,10,18.6,9.5,25,  changeOpacity(opts.colors[0], $("#label1").css('opacity')),"path1");
				drawEllipse(232,187,10,18.6,9.5,98,  changeOpacity(opts.colors[1], $("#label2").css('opacity')),"path2");
				drawEllipse(273,196,10,18.6,9.5,170, changeOpacity(opts.colors[2], $("#label3").css('opacity')),"path3");
				drawEllipse(282,238,10,18.6,9.5,62,  changeOpacity(opts.colors[3], $("#label4").css('opacity')),"path4");
				drawEllipse(242,260,10,18.6,9.5,134, changeOpacity(opts.colors[4], $("#label5").css('opacity')),"path5");
				...
				drawEllipse(181,238,10,18.5,11.5,40,  changeOpacity(opts.colors[0], $("#label1").css('opacity')),"path1");
				drawEllipse(242,177,10,18.5,11.5,40,  changeOpacity(opts.colors[1], $("#label2").css('opacity')),"path2");
				drawEllipse(259,177,10,18.5,11.5,140, changeOpacity(opts.colors[2], $("#label3").css('opacity')),"path3");
				drawEllipse(320,238,10,18.5,11.5,140, changeOpacity(opts.colors[3], $("#label4").css('opacity')),"path4");
				...
				drawEllipse(171,142,120,1,1,0, changeOpacity(opts.colors[0], $("#label1").css('opacity')),"path1");
				drawEllipse(327,142,120,1,1,0, changeOpacity(opts.colors[1], $("#label2").css('opacity')),"path2");
				drawEllipse(249,271,120,1,1,0, changeOpacity(opts.colors[2], $("#label3").css('opacity')),"path3");
				...
				drawEllipse(171,206,140,1,1,0, changeOpacity(opts.colors[0], $("#label1").css('opacity')),"path1");
				drawEllipse(327,206,140,1,1,0, changeOpacity(opts.colors[1], $("#label2").css('opacity')),"path2");
		...
		function placeEdwardsVenn(vennSize) {
			if (vennSize == 6) {
				drawCircle(246,206,90,1,1,0, changeOpacity(opts.colors[0], $("#label1").css('opacity')),"path1");
				drawRoundRect(245,25,250,365,changeOpacity(opts.colors[1], $("#label2").css('opacity')),"path2");
				drawRoundRect(5,205,490,185,changeOpacity(opts.colors[2], $("#label3").css('opacity')),"path3");
				drawDoubleCircle(changeOpacity(opts.colors[3], $("#label4").css('opacity')),"path4");
				drawCross(changeOpacity(opts.colors[4], $("#label5").css('opacity')),"path5");
				drawCross2(changeOpacity(opts.colors[5], $("#label6").css('opacity')),"path6");
				...
				drawCircle(246,206,110,1,1,0, changeOpacity(opts.colors[0], $("#label1").css('opacity')),"path1");
				drawRoundRect(245,25,250,365, changeOpacity(opts.colors[1], $("#label2").css('opacity')),"path2");
				drawRoundRect(5,205,490,185,  changeOpacity(opts.colors[2], $("#label3").css('opacity')),"path3");
		...
		function addExportModule(div, extraheight, type){
			...
			var getTime = function(time) {
				...
				var s = t.getSeconds();
				s = s < 10 ? ('0' + s) : s;
				var createTime = ""+y + mon + d + h + min + s;
				return createTime;
			};
			$("#format-png").click(function(event) {
				...
				img.onload = function() {
					...
					$('#data-export').attr("download", "venn_"+getTime(new Date())+".png");
					$('#data-export')[0].click();
				};
			});
			$("#format-svg").click(function(event) {
				...
				$('#data-export').attr("download", "venn_"+getTime(new Date())+".svg");
				$('#data-export')[0].click();
        ...
        this.each(function() {
			...
			div_content += '<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.6;" id="label1"></div>';
			div_content += '<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.6;" id="label2"></div>';
			div_content += '<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.6;" id="label3"></div>';
			div_content += '<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.6;" id="label4"></div>';
			div_content += '<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.6;" id="label5"></div>';
			div_content += '<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.6;" id="label6"></div>';
			div_content += '</div>';
            $t.html(div_content);
