...
$(function(){
	...
	for(var i=0;i<data.length;i++){
		...
		var item = '<li><div class="checked"><input type="checkbox" name="'+id+'" id="'+id+'"></div><div class="favorites-list-link"><a href="'+url+'" title="'+title+'"><div class="tag"><span>'+cat_id+'</span>'+cat_name+'</div><h3>'+title+'</h3><p>'+pubtime+'</p></a></div></li>';
...
$(function(){
	...
	for(var i=0;i<data.length;i++){
		...
		var item = '<li><div class="checked"><input type="checkbox" name="'+id+'" id="'+id+'"></div><div class="comment-list-link"><a href="'+url+'" title="'+title+'"><div class="tag"><span>'+cat_id+'</span>'+cat_name+'</div><h3>'+title+'</h3><h3 class="comment-info">'+comment+'</h3><p>2016.09.19</p></a></div></li>';
